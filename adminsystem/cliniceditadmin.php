...
if ($result) { // If it ran OK, display the records
				...
				<td class="col head"><b>Total Rooms</b><td class="col head"><b>Edit</b></td><td class="last"><b>Delete</b></td></tr>';
				...
				<td class="col"><a href="edit_clinicinfo.php?id=' . $row['cid'] . '">Edit</a></td>
				<td class="last1"><a href="deleteclinic.php?id=' . $row['cid'] . '">Delete</a></td>
                </tr>'; }
