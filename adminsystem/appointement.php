...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
            ...
            $q = "INSERT INTO appointement (userid,code,dentist,regdate,regtime,status,clinic)
            VALUES ('".$_SESSION['userid']."', '$codes','$dent','$dates','$time','Not Confirmed','$clinic')";
...
<?php
      ...
      mysql_select_db("dental")or die("Connection Failed");
      $query = "SELECT concat(cname,'-',location) AS codes FROM clinic";
      $result = mysql_query($query);
      ?>

      <label for="clinic">Dental Clinic:<select name="clinic" value="<?php if (isset($_POST['clinic'])) echo $_POST['clinic']; ?>" >
      <?php
