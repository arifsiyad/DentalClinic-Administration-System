...
// Make the query
$q = "DELETE FROM adminreg WHERE ser=$id LIMIT 1";
...
echo '<h3>The date has NOT been deleted.</h3>';
}
} else { // Display the form
// Retrieve the member's data #3
$q = "SELECT regdate FROM adminreg WHERE ser=$id";
$result = @mysqli_query ($dbcon , $q);
...
echo '<form action="deleteappoint.php" method="post"> 
